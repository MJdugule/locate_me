  ...
  Future<void> signInWithGoogle(context) async {
    try{
      ...
      if(user == null){
        ...
        final GoogleSignInAuthentication _googleAuth = await user.authentication;
        ...
        final UserCredential userCredential = await FirebaseAuth.instance.signInWithCredential(_oAuth);
